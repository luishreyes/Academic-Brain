...
aliases: [adaptive laboratory evolution, ALE, evolutionary engineering, in vitro evolution, VERT, visualizing evolution in real-time]
---

# Evolución de laboratorio

Técnica experimental en que una población microbiana es sometida a presión selectiva durante múltiples generaciones para identificar mutantes con fenotipos mejorados; permite mapear el paisaje adaptativo de fenotipos complejos.
