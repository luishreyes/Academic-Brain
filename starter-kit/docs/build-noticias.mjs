...
//
// Lee los archivos .md de las carpetas listadas en COLLECTIONS, los convierte a HTML
...
// EDITE ESTO. Una entrada por cada carpeta de boletines que quiera publicar en
// el lector. `dir` es el nombre de la carpeta en la raíz del repo; `label` es el
// título que aparece en el menú. Puede tener una sola colección o varias.
const COLLECTIONS = [
  { dir: "Boletines", label: "Boletín semanal" },
  // { dir: "Boletines-TemaB", label: "Otro tema" },
];
